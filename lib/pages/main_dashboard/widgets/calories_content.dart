  ...
  return GetBuilder<MealController>(
    builder: (mealController) {
      return GetBuilder<ExerciseController>(builder: (exerciseController) {
        final remainingCalories = exerciseController.targetCalories - mealController.calcoriesConsumed;
                  ...
                  AppIconText(
                      ...
                      text: Column(
                        children: [
                          ...
                          ColoredText(
                            text: '${exerciseController.targetCalories.toStringAsFixed(0)}',
                            fontSize: 12,
                          ),
                        ],
                      )),
                   ...
                   AppIconText(
                    ...
                    text: Column(
                      children: [
                        ...
                        ColoredText(
                          text: '${mealController.calcoriesConsumed.toStringAsFixed(0)}',
                          fontSize: 12,
                        ),
                      ],
                    ),
